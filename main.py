...
from Assets.brick import Brick, shape
from Assets.boss import Boss

WIDTH, HEIGHT = 900, 900
WIN = pygame.display.set_mode((WIDTH, HEIGHT))
pygame.display.set_caption('Space Invaders!')
logo = pygame.image.load(os.path.join('Assets', 'med_alien_step.png'))
...
def get_hiscore():
    try:
        with open('Assets/scores.txt', 'r') as hi_score:
...
def display_hud(player):
    ...
    WIN.blit(hiscore, (WIDTH - hiscore.get_size()[0] - 10, 10))
    WIN.blit(score, (20, 10))
